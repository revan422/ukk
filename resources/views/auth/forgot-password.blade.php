...
<head>
    <meta charset="UTF-8">
    <title>Lupa Password - SkyLine Airlines</title>
                ...
                <div class="reset-card">
                    <div class="card-body p-5">
                        ...
                        @if (session('status'))
                            ...
                            @if (session('testing_reset_link'))
                                <div class="alert alert-warning small mt-2" style="background: rgba(244, 180, 0, 0.1); border: 1px solid rgba(244, 180, 0, 0.3); color: #f4b400; text-align: left;">
                                    <strong>[Testing Link Helper]:</strong><br>
                                    Anda dapat langsung mengklik link di bawah ini untuk mereset password:<br>
                                    <a href="{{ session('testing_reset_link') }}" class="fw-bold text-gold" style="text-decoration: underline;">Klik di sini untuk Reset Password</a>
                                </div>
                            @endif
                        @endif
                        ...
                        <form action="{{ route('password.email') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-gold w-100 mb-3">Kirim Link Reset</button>
                        </form>
